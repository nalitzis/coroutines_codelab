...
class TitleRepositoryTest {
    ...
    fun whenRefreshTitleSuccess_insertsRows() = runBlockingTest {
        val titleDaoFake = TitleDaoFake("title")
        val subject = TitleRepository(MainNetworkFake("OK"), titleDaoFake)
        subject.refreshTitle()
        Truth.assertThat(titleDaoFake.nextInsertedOrNull()).isEqualTo("OK")
    }
